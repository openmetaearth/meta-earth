...
var (
	pattern_Query_Params_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"me-chain", "meservice", "params"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_FixedDeposit_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3}, []string{"me-chain", "meservice", "fixed_deposit", "id"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_FixedDepositAll_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"me-chain", "meservice", "fixed_deposit"}, "", runtime.AssumeColonVerbOpt(true)))
)
