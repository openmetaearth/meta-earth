...
// x/meservice module sentinel errors
var (
	...
	ErrFixedDepositVaultNotExists = sdkerrors.Register(ModuleName, 1154, "fixed deposit vault not exists")
	...
	ErrAmountNotPositive          = sdkerrors.Register(ModuleName, 1160, "amount not positive")

	ErrSetClearHeight = sdkerrors.Register(ModuleName, 1170, "set clear height failed")
	ErrGetClearHeight = sdkerrors.Register(ModuleName, 1171, "get clear height failed")
